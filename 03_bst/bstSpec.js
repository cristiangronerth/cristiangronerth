describe('BinarySearchTree', function() {
  ...
  xit('tiene métodos llamados `insert`, `contains`, `depthFirstForEach`, `breadthFirstForEach` y `size`', function() {
  ...
  xit('toma valores y reporta el tamaño correctamente', function () {
    tree.insert(12);
    expect(tree.size()).toBe(2);
  });

  xit('hace nodos en la rama correcta', function () {
  ...
  xit('ordena valores cuando agrega', function() {
  ...
  xit('`contains` devuelve true si el valor esta en el `tree`', function() {
  ...
  xit('`contains` devuelve false si el valor no esta en el tree', function() {
    valuesToInsert.forEach(function(value){
      tree.insert(value);
    });
  ...
  xit('corre `depth-first` (en recorrido "in-order") cuando `depthFirstForEach` es ejecutado sin ningún argumento o con "in-order"', function() {
    valuesToInsert.forEach(function(value){
        tree.insert(value);
    });
  ...
  xit('corre `depth-first` (en recorrido "pre-order") cuando `depthFirstForEach` es ejecutado con el argumento "pre-order"', function() {
    valuesToInsert.forEach(function(value){
        tree.insert(value);
    });
  ...
  xit('corre depth-first (en recorrido "post-order" cuando depthFirstForEach() es ejecutado con la opcion "post-order"', function() {
    valuesToInsert.forEach(function(value){
        tree.insert(value);
    });
  ...
  xit('corre `breadth-first` cuando `breadthFirstForEach` es ejecutado', function() {
