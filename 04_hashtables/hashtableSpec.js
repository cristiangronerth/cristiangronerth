describe("HashTable", function () {
  ...
  it("deberia guardar y buscar valores por key", function () {
    //Recordá cómo deberías guardar las keys en una hashtable! Las hashtables NO son objetos de Javascript
  ...
  it("deberia guardar los keys hasheados, no usar la Hashtable como un objeto de Javascript", function () {
    //Este test debería pasar automáticamente si implementaste el get y el set correctamente
